...
my $listen_sock = IO::Socket::INET->new( LocalPort => 0, Listen => 1 );
...
# A micro mocking framework
{
   ...
   *IO::Socket::SSL::sysread = sub {
      ...
      @EXPECT or fail( "Expected no more calls, got sysread" ), return undef;
      my $e = shift @EXPECT;
      $e->[0] eq "sysread" or fail( "Expected $e->[0], got sysread" ), return undef;
      pass( "Got sysread" );
   ...
   *IO::Socket::SSL::syswrite = sub {
      my ( $fh, $buff, $len ) = @_;
      @EXPECT or fail( "Expected no more calls, got syswrite" ), return undef;
      my $e = shift @EXPECT;
      $e->[0] eq "syswrite" or fail( "Expected $e->[0], got syswrite" ), return undef;
      pass( "Got syswrite" );
